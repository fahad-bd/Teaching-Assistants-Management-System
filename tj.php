...
?>
    ...
    <section class="singlepost">
        <div class="container singlepost__container">
            ...
            <p>
                <b>Vision Statement of CSE Department</b>
            </p>
            <p style="text-align: justify;">
            ...
            <p>
            <b>Mission of CSE Department</b>
            </p>
            <p style="text-align: justify;">
            (i) To advance knowledge and learning of evolving challenges in Computer Science and Engineering through quality education and research towards the development of the society.
            <br><br>
            (ii) To sustain an outstanding hub dedicated to excellence in teaching, learning, and research and to become internationally recognized to meet national and international needs.
            <br><br>
            (iii) To enhance the quality of students with advanced knowledge and skills of Computer Science and Engineering to meet contemporary industrial requirements.
            </p>
        </div>  
    </section>
    <!--------------------------------------- End Post Body ----------------------------------->
